...
📊 Excel Avançado: Tratamento inicial da base, fórmulas para padronização de textos, limpeza de valores truncados e validação dos dados antes e depois da sanitização.

🤖 ChatGPT, Gemini e Claude: Utilizados de forma combinada e alternada para:

Criar as regras de sanitização de dados (schema).

Gerar a estrutura de código em HTML, CSS e JavaScript puro (sem bibliotecas externas).
...
Filtros Dinâmicos: Filtre vendas por Modelo, Ano, Forma de Pagamento e Região em tempo real.
